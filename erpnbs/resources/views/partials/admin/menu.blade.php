                ...
                <ul class="dash-navbar">
                    ...
                    <!--------------------- Start Account ----------------------------------->
                        ...
                        @if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract'))
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'deals' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'contract') ?' active dash-trigger':''}}">
                                ...
                                <ul class="dash-submenu {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'show':''}}">
                                    ...
                                    @endif
                                    {{-- <li class="dash-item {{ (Request::segment(1) == 'activities')?'active':''}}">
                                        <a class="dash-link" href="{{ route('activities.index') }}">{{__('Activities ')}}</a>
                                    </li> --}}
                                </ul>
                            </li>
                        @endif
                        ...
                        @if($show_dashboard == 1)
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'deals' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'contract') ?' active dash-trigger':''}}">
                                <a href="#!" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-layers-difference"></i></span
                                    ><span class="dash-mtext">{{__('Manage Activities')}}</span
                                    ><span class="dash-arrow"><i data-feather="chevron-right"></i></span
                                    ></a>
                                <ul class="dash-submenu {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'show':''}}">
                                    <li class="dash-item {{ (Request::segment(1) == 'all')?'active':''}}">
                                        <a class="dash-link" href="{{ route('activities.show.all') }}">{{__('all ')}}</a>
                                    </li>
                                    <li class="dash-item {{ (Request::segment(1) == 'activities')?'active':''}}">
                                        <a class="dash-link" href="{{ route('activities.index') }}">{{__('Activities ')}}</a>
                                    </li>
                    ...
                    @endif
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext">{{__('Purchase')}}</span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                            </a>
                            ...
                            <ul class="dash-submenu">
                                ...
                                @endif
                                <li class="dash-item {{ (Request::segment(1) == 'vender')?'active':''}}">
                                    <a href="{{ route('vender.index') }}" class="dash-link">{{__('Vendor')}}
                                    </a>
                                </li>
                                <li class="dash-item {{ (Request::segment(1) == 'purchases' && Request::segment(2) == 'vendor_items') ? 'active' : '' }}">
                                    <a href="{{ route('vendor_items.index') }}" class="dash-link">{{ __('Vendor Products') }}</a>
                                </li>
                                <li class="dash-item {{ (Request::segment(1) == 'purchases' && Request::segment(2) == 'purchase_request') ? 'active' : '' }}">
                                    <a href="{{ route('purchase_request.index') }}" class="dash-link">{{ __('Purchase Request') }}</a>
                                </li>
                                <li class="dash-item {{ (Request::segment(1) == 'purchases' && Request::segment(2) == 'quotations') ? 'active' : '' }}">
                                    <a href="{{ route('quotations.index') }}" class="dash-link">{{ __('Quotations') }}</a>
                                </li>
                            ...
                            <ul class="dash-submenu">
                                ...
                                @can('manage role')
                                    <li class="dash-item {{ (Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'roles.create' || Request::route()->getName() == 'roles.edit') ? ' active' : '' }} ">
                                        <a class="dash-link" href="{{route('roles.index')}}">{{__('Permission')}}</a>
                                    </li>
                                @endcan
                                @can('manage client')
