...
class Customer extends Authenticatable
{
    ...
    {
        return $this->hasOne('App\Models\CustomerStage', 'id', 'stage_id');
    }
    ...
    {
        return $this->hasMany('App\Models\CustomerEmail', 'customer_id', 'id')->orderByDesc('id');
    }

    public function calls()
    {
        return $this->hasMany('App\Models\CustomerCall', 'customer_id', 'id');
    }
    public function tasks()
    {
        return $this->hasMany('App\Models\CustomerTask', 'customer_id', 'id');
    }
    public function meetings()
    {
        return $this->hasMany('App\Models\CustomerMeeting', 'customer_id', 'id');
    }
    public function visits()
    {
        return $this->hasMany('App\Models\CustomerVisit', 'customer_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\CustomerDiscussion', 'customer_id', 'id')->orderBy('id', 'desc');
    }
    ...
    {
        return $this->hasMany('App\Models\CustomerFile', 'customer_id', 'id');
    }
    public function activities()
    {
        return $this->hasMany('App\Models\CustomerActivityLog', 'customer_id', 'id')->orderBy('id', 'desc');
    }
