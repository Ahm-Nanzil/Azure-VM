@if(isset($meeting))
    {{ Form::model($meeting, array('route' => ['leads.meeting.update', $lead->id, $meeting->id], 'method' => 'PUT', 'class' => 'modalForm')) }}
@else
    {{ Form::open(array('route' => ['leads.meeting.store', $id], 'class' => 'modalForm')) }}
@endif
