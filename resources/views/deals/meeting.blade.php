@if(isset($meeting))
    {{ Form::model($meeting, array('route' => ['deals.meeting.update', $deal->id, $meeting->id], 'method' => 'PUT', 'class' => 'modalForm')) }}
@else
    {{ Form::open(array('route' => ['deals.meeting.store', $id], 'class' => 'modalForm')) }}
@endif
