...
use App\Http\Controllers\HierarchyRoleController;
...
Route::get('roles/{role}/edit-single', [RoleController::class, 'editSingle'])
    ->name('roles.edit.single')
    ->middleware(['auth', 'XSS', 'revalidate']);
Route::put('roles-single/{role}', [RoleController::class, 'updateSingle'])->name('roles.update.single')->middleware(['auth', 'XSS', 'revalidate']);
...
Route::group(
    [
        ...
        Route::post('/customer/change-pipeline', [CustomerController::class, 'changePipeline'])->name('customer.change.pipeline');
        ...
        Route::get('customer/{id}/deal', [CustomerController::class, 'showDeal'])->name('customer.deal');
        Route::get('/customer/{id}/basicinfo', [CustomerController::class, 'basicinfoEdit'])->name('customer.basicinfo.edit');
        Route::put('/customer/{id}/basicinfo', [CustomerController::class, 'basicinfoUpdate'])->name('customer.basicinfo.update');
        Route::get('/customer/{id}/sources', [CustomerController::class, 'sourceEdit'])->name('customer.sources.edit');
        Route::put('/customer/{id}/sources', [CustomerController::class, 'sourceUpdate'])->name('customer.sources.update');
        Route::delete('/customer/{id}/sources/{uid}', [CustomerController::class, 'sourceDestroy'])->name('customer.sources.destroy');
        Route::get('/customer/{id}/primarycontact', [CustomerController::class, 'primarycontactEdit'])->name('customer.primarycontact.edit');
        Route::put('/customer/{id}/primarycontact', [CustomerController::class, 'primarycontactUpdate'])->name('customer.primarycontact.update');
        Route::get('/customer/{id}/contact', [CustomerController::class, 'contactCreate'])->name('customer.additional-contact.create');
        Route::post('/customer/{id}/contact', [CustomerController::class, 'contactStore'])->name('customer.additional-contact.store');
        Route::delete('customer/{id}/additional_contacts/{index}', [CustomerController::class, 'contactDistroy'])->name('customer.additional_contacts.destroy');
        Route::post('/check-duplicate-website', [CustomerController::class, 'checkDuplicateWebsite'])->name('check.duplicate.website');

        // customer email
        Route::get('/customer/{id}/email', [CustomerController::class, 'emailCreate'])->name('customer.emails.create');
        Route::post('/customer/{id}/email', [CustomerController::class, 'emailStore'])->name('customer.emails.store');

        // customer calls

        Route::get('/customer/{id}/call', [CustomerController::class, 'callCreate'])->name('customer.calls.create');
        Route::post('/customer/{id}/call', [CustomerController::class, 'callStore'])->name('customer.calls.store');
        Route::get('/customer/{id}/call/{cid}/edit', [CustomerController::class, 'callEdit'])->name('customer.calls.edit');
        Route::put('/customer/{id}/call/{cid}', [CustomerController::class, 'callUpdate'])->name('customer.calls.update');
        Route::delete('/customer/{id}/call/{cid}', [CustomerController::class, 'callDestroy'])->name('customer.calls.destroy');

        // customer Tasks
        Route::get('/customer/{id}/task', [CustomerController::class, 'taskCreate'])->name('customer.tasks.create');
        Route::post('/customer/{id}/task', [CustomerController::class, 'taskStore'])->name('customer.tasks.store');
        Route::get('/customer/{id}/task/{tid}/edit', [CustomerController::class, 'taskEdit'])->name('customer.tasks.edit');
        Route::put('/customer/{id}/task/{tid}', [CustomerController::class, 'taskUpdate'])->name('customer.tasks.update');
        Route::delete('/customer/{id}/task/{tid}', [CustomerController::class, 'taskDestroy'])->name('customer.tasks.destroy');

        // Lead Meeting
        Route::get('/customer/{id}/meeting', [CustomerController::class, 'meetingCreate'])->name('customer.meeting.create');
        Route::post('/customer/{id}/meeting', [CustomerController::class, 'meetingStore'])->name('customer.meeting.store');
        Route::get('/customer/{id}/meeting/{mid}/edit', [CustomerController::class, 'meetingEdit'])->name('customer.meeting.edit');
        Route::put('/customer/{id}/meeting/{mid}', [CustomerController::class, 'meetingUpdate'])->name('customer.meeting.update');
        Route::delete('/customer/{id}/meeting/{mid}', [CustomerController::class, 'meetingDestroy'])->name('customer.meeting.destroy');

        // Deal visit
        Route::get('/customer/{id}/visit', [CustomerController::class, 'visitCreate'])->name('customer.visit.create');
        Route::post('/customer/{id}/visit', [CustomerController::class, 'visitStore'])->name('customer.visit.store');
        Route::get('/customer/{id}/visit/{vid}/edit', [CustomerController::class, 'visitEdit'])->name('customer.visit.edit');
        Route::put('/customer/{id}/visit/{vid}', [CustomerController::class, 'visitUpdate'])->name('customer.visit.update');
        Route::delete('/customer/{id}/visit/{vid}', [CustomerController::class, 'visitDestroy'])->name('customer.visit.destroy');

        //Dicussion
        Route::post('/customer/{id}/discussions', [CustomerController::class, 'discussionStore'])->name('customer.discussion.store');

        // Files
        Route::post('/customer/{id}/file', [CustomerController::class, 'fileUpload'])->name('customer.file.upload');
        Route::get('/customer/{id}/file/{fid}', [CustomerController::class, 'fileDownload'])->name('customer.file.download');
        Route::delete('/customer/{id}/file/delete/{fid}', [CustomerController::class, 'fileDelete'])->name('customer.file.delete');

        //Products
        Route::get('/customer/{id}/products', [CustomerController::class, 'productEdit'])->name('customer.products.edit');
        Route::put('/customer/{id}/products', [CustomerController::class, 'productUpdate'])->name('customer.products.update');
        Route::delete('/customer/{id}/products/{uid}', [CustomerController::class, 'productDestroy'])->name('customer.products.destroy');

        Route::post('/customer/json', [CustomerController::class, 'json'])->name('customer.json');
...
// Deal Filter
Route::post('/deals/filter', [DealController::class, 'dealFilter'])->name('deals.filter')->middleware(['auth', 'XSS']);
...
// deal basic info
Route::get('/deals/{id}/basicinfo', [DealController::class, 'basicinfoEdit'])->name('deals.basicinfo.edit')->middleware(['auth', 'XSS']);
Route::put('/deals/{id}/task', [DealController::class, 'basicinfoUpdate'])->name('deals.basicinfo.update')->middleware(['auth', 'XSS']);

// primary contact info
Route::get('/deals/{id}/primarycontact', [DealController::class, 'primarycontactEdit'])->name('deals.primarycontact.edit')->middleware(['auth', 'XSS']);
Route::put('/deals/{id}/primarycontact', [DealController::class, 'primarycontactUpdate'])->name('deals.primarycontact.update')->middleware(['auth', 'XSS']);

// Deal additional Contact
Route::get('/deals/{id}/contact', [DealController::class, 'contactCreate'])->name('deals.additional-contact.create')->middleware(['auth', 'XSS']);
Route::post('/deals/{id}/contact', [DealController::class, 'contactStore'])->name('deals.additional-contact.store')->middleware(['auth', 'XSS']);
Route::delete('deals/{id}/additional_contacts/{index}', [DealController::class, 'contactDistroy'])->name('deals.additional_contacts.destroy');

// Deal Meeting
Route::get('/deals/{id}/meeting', [DealController::class, 'meetingCreate'])->name('deals.meeting.create')->middleware(['auth', 'XSS']);
Route::post('/deals/{id}/meeting', [DealController::class, 'meetingStore'])->name('deals.meeting.store')->middleware(['auth', 'XSS']);
Route::get('/deals/{id}/meeting/{mid}/edit', [DealController::class, 'meetingEdit'])->name('deals.meeting.edit')->middleware(['auth', 'XSS']);
Route::put('/deals/{id}/meeting/{mid}', [DealController::class, 'meetingUpdate'])->name('deals.meeting.update')->middleware(['auth', 'XSS']);
Route::delete('/deals/{id}/meeting/{mid}', [DealController::class, 'meetingDestroy'])->name('deals.meeting.destroy')->middleware(['auth', 'XSS']);

// Deal visit
Route::get('/deals/{id}/visit', [DealController::class, 'visitCreate'])->name('deals.visit.create')->middleware(['auth', 'XSS']);
Route::post('/deals/{id}/visit', [DealController::class, 'visitStore'])->name('deals.visit.store')->middleware(['auth', 'XSS']);
Route::get('/deals/{id}/visit/{vid}/edit', [DealController::class, 'visitEdit'])->name('deals.visit.edit')->middleware(['auth', 'XSS']);
Route::put('/deals/{id}/visit/{vid}', [DealController::class, 'visitUpdate'])->name('deals.visit.update')->middleware(['auth', 'XSS']);
Route::delete('/deals/{id}/visit/{vid}', [DealController::class, 'visitDestroy'])->name('deals.visit.destroy')->middleware(['auth', 'XSS']);

Route::post('/deals/json', [LeadController::class, 'json'])->name('deals.json');
...
Route::post('/leads/change-pipeline', [LeadController::class, 'changePipeline'])->name('leads.change.pipeline')->middleware(['auth', 'XSS']);
...
// Lead Tasks
Route::get('/leads/{id}/task', [LeadController::class, 'taskCreate'])->name('leads.tasks.create')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/task', [LeadController::class, 'taskStore'])->name('leads.tasks.store')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/task/{tid}/edit', [LeadController::class, 'taskEdit'])->name('leads.tasks.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/task/{tid}', [LeadController::class, 'taskUpdate'])->name('leads.tasks.update')->middleware(['auth', 'XSS']);
Route::delete('/leads/{id}/task/{tid}', [LeadController::class, 'taskDestroy'])->name('leads.tasks.destroy')->middleware(['auth', 'XSS']);

// Lead Meeting
Route::get('/leads/{id}/meeting', [LeadController::class, 'meetingCreate'])->name('leads.meeting.create')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/meeting', [LeadController::class, 'meetingStore'])->name('leads.meeting.store')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/meeting/{mid}/edit', [LeadController::class, 'meetingEdit'])->name('leads.meeting.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/meeting/{mid}', [LeadController::class, 'meetingUpdate'])->name('leads.meeting.update')->middleware(['auth', 'XSS']);
Route::delete('/leads/{id}/meeting/{mid}', [LeadController::class, 'meetingDestroy'])->name('leads.meeting.destroy')->middleware(['auth', 'XSS']);

// Lead visit
Route::get('/leads/{id}/visit', [LeadController::class, 'viewCreate'])->name('leads.visit.create')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/visit', [LeadController::class, 'viewStore'])->name('leads.visit.store')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/visit/{vid}/edit', [LeadController::class, 'viewEdit'])->name('leads.visit.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/visit/{vid}', [LeadController::class, 'viewUpdate'])->name('leads.visit.update')->middleware(['auth', 'XSS']);
Route::delete('/leads/{id}/visit/{vid}', [LeadController::class, 'viewDestroy'])->name('leads.visit.destroy')->middleware(['auth', 'XSS']);
Route::get('/leads/recurrence', [LeadController::class, 'recurrenceCheck'])->name('leads.recurrence')->middleware(['auth', 'XSS']);
...
// lead additional Contact
Route::get('/leads/{id}/contact', [LeadController::class, 'contactCreate'])->name('leads.additional-contact.create')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/contact', [LeadController::class, 'contactStore'])->name('leads.additional-contact.store')->middleware(['auth', 'XSS']);
Route::delete('leads/{id}/additional_contacts/{index}', [LeadController::class, 'contactDistroy'])->name('leads.additional_contacts.destroy');

// lead basic info
Route::get('/leads/{id}/basicinfo', [LeadController::class, 'basicinfoEdit'])->name('leads.basicinfo.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/task', [LeadController::class, 'basicinfoUpdate'])->name('leads.basicinfo.update')->middleware(['auth', 'XSS']);

// primary contact info
Route::get('/leads/{id}/primarycontact', [LeadController::class, 'primarycontactEdit'])->name('leads.primarycontact.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/primarycontact', [LeadController::class, 'primarycontactUpdate'])->name('leads.primarycontact.update')->middleware(['auth', 'XSS']);

// Leads Filter
Route::post('/leads/filter', [LeadController::class, 'leadFilter'])->name('leads.filter')->middleware(['auth', 'XSS']);

// end Leads Module

// start Customer Stage
Route::post('/customer_stages/order', [CustomerController::class, 'order'])->name('customer_stages.order')->middleware(['auth', 'XSS']);

Route::resource('customer_stages', CustomerStageController::class)->middleware(['auth']);
...
Route::resource('activities', ActivitiesController::class)->middleware(['auth', 'XSS']);
Route::get('/activities/show/all', [ActivitiesController::class, 'task'])->name('activities.show.all')->middleware(['auth']);
...
Route::get('test', [HierarchyRoleController::class, 'index'])->name('test');
Route::get('/get-flash-message', [HierarchyRoleController::class, 'getFlashMessage'])->name('get.flash.message');
Route::get('/get-stages', [DealController::class, 'json'])->name('get.stages');

use Illuminate\Support\Facades\Mail;

Route::get('/test-email', function () {
    $toEmail = 'example@example.com'; // Replace with the recipient email address

    // Test email details
    $details = [
        'subject' => 'Test Email',
        'body' => 'This is a test email sent from Laravel using the provided mail configuration.',
    ];

    // Send the email
    Mail::raw($details['body'], function ($message) use ($toEmail, $details) {
        $message->to($toEmail)
