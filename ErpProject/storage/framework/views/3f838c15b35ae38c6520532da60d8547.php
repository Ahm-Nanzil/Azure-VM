<?php echo e(Form::model($role,array('route' => array('roles.update.single', $role->id), 'method' => 'PUT'))); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('name', null, array('class' => 'form-control', 'placeholder' => __('Enter Role Name'), 'readonly' => 'readonly'))); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-inventory-tab" data-bs-toggle="pill" href="#inventory" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('Inventory')); ?></a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                ...
                                <table class="table table-striped mb-0" id="">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($module == 'pipeline'): ?>

                                    <tr class="expandable-row">
                                        <td>
                                            <input type="checkbox" class="form-check-input align-middle ischeck crm_checkall" data-id="<?php echo e(str_replace(' ', '', $module)); ?>">
                                        </td>
                                        <td>
                                            <label class="ischeck crm_checkall" data-id="<?php echo e(str_replace(' ', '', $module)); ?>"><?php echo e(ucfirst($module)); ?></label>
                                            <span class="toggle-icon toggle-row">&#9654;</span>
                                        ...
                                        <tr class="details-row" style="display:none;">
                                            <td colspan="3">
                                                <div class="details-container">
                                                    <input type="checkbox" class="form-check-input align-middle ischeck crm_checkall" data-id="<?php echo e(str_replace(' ', '', $pipeline->name)); ?>">
                                                    <label class="ischeck crm_checkall" data-id="<?php echo e(str_replace(' ', '', $pipeline->name)); ?>">
                                                        <?php echo e(ucfirst($pipeline->name)); ?>

                                                    </label>
                                                    <div class="row">
                                                        <?php if(in_array('manage pipeline '.$pipeline->name,(array) $permissions)): ?>
                                                            <?php if($key = array_search('manage pipeline '.$pipeline->name,$permissions)): ?>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input crm_checkall isscheck_'.str_replace(' ', '', $pipeline->name),'id' =>'permission'.$key])); ?>

                                                                    <?php echo e(Form::label('permission'.$key,'Manage',['class'=>'custom-control-label'])); ?><br>
                                                                </div>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                        <?php if(in_array('create pipeline '.$pipeline->name,(array) $permissions)): ?>
                                                            <?php if($key = array_search('create pipeline '.$pipeline->name,$permissions)): ?>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input crm_checkall isscheck_'.str_replace(' ', '', $pipeline->name),'id' =>'permission'.$key])); ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                        <?php if(in_array('edit pipeline '.$pipeline->name,(array) $permissions)): ?>
                                                            <?php if($key = array_search('edit pipeline '.$pipeline->name,$permissions)): ?>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input crm_checkall isscheck_'.str_replace(' ', '', $pipeline->name),'id' =>'permission'.$key])); ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                        <?php if(in_array('delete pipeline '.$pipeline->name,(array) $permissions)): ?>
                                                            <?php if($key = array_search('delete pipeline '.$pipeline->name,$permissions)): ?>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input crm_checkall isscheck_'.str_replace(' ', '', $pipeline->name),'id' =>'permission'.$key])); ?>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            // Toggle visibility of the details rows and arrow direction
                                            $('.toggle-row').on('click', function() {
                                                const $icon = $(this);

                                                // Check current arrow direction and toggle it
                                                const isExpanded = $icon.html() === '&#9660;'; // Down arrow
                                                $icon.html(isExpanded ? '&#9654;' : '&#9660;'); // Toggle between right (&#9654;) and down (&#9660;)

                                                // Toggle visibility of rows
                                                $icon.closest('tr').nextUntil('.expandable-row', '.details-row').toggle();
                                            });
                                        });
                                    </script>
                ...
                <div class="tab-pane fade" id="inventory" role="tabpanel" aria-labelledby="pills-inventory-tab">
                    <?php
                        $modules=['inventory items','receiving voucher','stock export','serial number','packing lists','delivery note', 'loss & adjustment', 'return order','inventory warehouse','inventory history','inventory report','inventory settings'];
                    ?>
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                <h6 class="my-3"><?php echo e(__('Assign Inventory Setup related Permission to Roles')); ?></h6>
                                <table class="table table-striped mb-0" id="">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input align-middle custom_align_middle" name="inventory_checkall"  id="inventory_checkall" >
                                        </th>
                                        <th><?php echo e(__('Module')); ?> </th>
                                        <th><?php echo e(__('Permissions')); ?> </th>
                                    </tr>
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="form-check-input align-middle ischeck inventory_checkall"  data-id="<?php echo e(str_replace(' ', '', $module)); ?>" ></td>
                                            <td><label class="ischeck inventory_checkall" data-id="<?php echo e(str_replace(' ', '', $module)); ?>"><?php echo e(ucfirst($module)); ?></label></td>
                                            <td>
...
<script>
    $(document).ready(function () {
        ...
        $("#inventory_checkall").click(function(){
            $('.inventory_checkall').not(this).prop('checked', this.checked);
        });
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/role/edit-single.blade.php ENDPATH**/ ?>