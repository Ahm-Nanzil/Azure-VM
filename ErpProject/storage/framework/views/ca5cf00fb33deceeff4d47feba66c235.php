...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('New')); ?></li>
<?php $__env->stopSection(); ?>
...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('hierarchy.create')); ?>" id="hierarchyForm">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('hierarchy_structure')); ?>" class="btn btn-secondary">Go Back</a>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Portfolio\myportfolio\ErpProject\resources\views/hierarchy/new.blade.php ENDPATH**/ ?>