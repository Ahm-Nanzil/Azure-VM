<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('product-category.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((Request::route()->getName() == 'product-category.index' ) ? 'active' : ''); ?>"><?php echo e(__('Income & Expense Categories')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/layouts/account_setup.blade.php ENDPATH**/ ?>