...
<?php $__env->stopPush(); ?>
<?php if(isset($call)): ?>
    <?php echo e(Form::model($call, array('route' => array('deals.calls.update', $deal->id, $call->id), 'method' => 'PUT', 'class' => 'modalForm'))); ?>

<?php else: ?>
    <?php echo e(Form::open(array('route' => ['deals.calls.store',$deal->id], 'class' => 'modalForm'))); ?>
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/deals/calls.blade.php ENDPATH**/ ?>