                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Product Type Code')); ?></th>
                                    <th><?php echo e(__('Product Type Name')); ?></th>
                                    ...
                                    <th><?php echo e(__('Tax 2')); ?></th>
                                    <th><?php echo e(__('Status')); ?></th>
                                    <th><?php echo e(__('Minimum Stock')); ?></th>
                                    <th><?php echo e(__('Maximum Stock')); ?></th>
                                    <th><?php echo e(__('Price After Tax')); ?></th>
                                    <th><?php echo e(__('Mother')); ?></th>
                                    <th><?php echo e(__('Date')); ?></th>
                                    <th><?php echo e(__('Inventory Vendor')); ?></th>
                                    <th><?php echo e(__('Expiration Date')); ?></th>
                                    <th><?php echo e(__('UOM')); ?></th>
                                    <th><?php echo e(__('Temperature Inwards Delivery')); ?></th>
                                    <th><?php echo e(__('Target Penjualan')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="font-style">
                                        ...
                                        <td><?php echo e($productService->images); ?></td>
                                        <td><?php echo e($productService->product_type_code); ?></td>
                                        <td><?php echo e($productService->product_type_name); ?></td>
                                        <td><?php echo e($productService->group_name); ?></td>
                                        <td><?php echo e($productService->warehouse_name); ?></td>
                                        <td><?php echo e($productService->tags); ?></td>
                                        <td><?php echo e($productService->inventory); ?></td>
                                        <td><?php echo e($productService->main_category); ?></td>
                                        <td><?php echo e($productService->sub_category); ?></td>
                                        <td><?php echo e($productService->child_category); ?></td>
                                        <td><?php echo e($productService->tax_2); ?></td>
                                        <td><?php echo e($productService->status ? __('Active') : __('Inactive')); ?></td>
                                        <td><?php echo e($productService->minimum_stock); ?></td>
                                        <td><?php echo e($productService->maximum_stock); ?></td>
                                        <td><?php echo e(\Auth::user()->priceFormat($productService->price_after_tax)); ?></td>
                                        <td><?php echo e($productService->mother); ?></td>
                                        <td><?php echo e($productService->date); ?></td>
                                        <td><?php echo e($productService->inventory_vendor); ?></td>
                                        <td><?php echo e($productService->expiration_date); ?></td>
                                        <td><?php echo e($productService->uom); ?></td>
                                        <td><?php echo e($productService->temperature_inwards_delivery); ?></td>
                                        <td><?php echo e(\Auth::user()->priceFormat($productService->target_penjualan)); ?></td>
                                        ...
                                        <td class="Action">
                                            ...
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(route('productservice.detail',$productService->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Warehouse Details')); ?>" data-title="<?php echo e(__('Warehouse Details')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/productservice/index.blade.php ENDPATH**/ ?>