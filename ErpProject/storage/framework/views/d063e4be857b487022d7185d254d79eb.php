...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('category_id', __('Expense Category'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('product_type_code', __('Product Type Code'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('product_type_code', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('product_type_name', __('Product Type Name'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('product_type_name', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('group_name', __('Group Name'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('group_name', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('warehouse_name', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('tags', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('inventory', __('Inventory'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('inventory', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('main_category', __('Main Category'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('main_category', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('sub_category', __('Sub Category'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('sub_category', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('child_category', __('Child Category'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('child_category', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('tax_2', __('Tax 2'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('tax_2', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('status', ['1' => 'Active', '0' => 'Inactive'], null, ['class' => 'form-control'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('minimum_stock', __('Minimum Stock'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('minimum_stock', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('maximum_stock', __('Maximum Stock'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('maximum_stock', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('price_after_tax', __('Price After Tax'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('price_after_tax', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('mother', __('Mother'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('mother', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('inventory_vendor', __('Inventory Vendor'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('inventory_vendor', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('expiration_date', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('uom', __('UOM'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('uom', '', array('class' => 'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('temperature_inwards_delivery', __('Temperature Inwards Delivery'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('temperature_inwards_delivery', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('target_penjualan', __('Target Penjualan'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('target_penjualan', '', array('class' => 'form-control', 'step'=>'0.01'))); ?>
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/productservice/create.blade.php ENDPATH**/ ?>