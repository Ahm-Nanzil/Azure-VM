<?php if(isset($task)): ?>
    <?php echo e(Form::model($task, array('route' => array('leads.tasks.update', $lead->id, $task->id), 'method' => 'PUT','class' => 'modalForm'))); ?>

<?php else: ?>
    <?php echo e(Form::open(array('route' => ['leads.tasks.store',$lead->id], 'class' => 'modalForm'))); ?>
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/leads/tasks.blade.php ENDPATH**/ ?>