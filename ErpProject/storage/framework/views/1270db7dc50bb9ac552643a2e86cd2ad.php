<?php echo e(Form::model($deal, array('route' => array('deals.update', $deal->id), 'method' => 'PUT', 'class' => 'modalForm'))); ?>
...
<div class="modal-body">
    ...
    <div class="row">
            ...
            <div class="col-6 form-group">
                ...
                <?php echo e(Form::select('deal_owner', $users, null, array('class' => 'form-control select','required'=>'required'))); ?>
            ...
            <div class="col-6 form-group">
                ...
                <div class="input-group">
                    ...
                    <?php echo e(Form::text('deal_name_additional',$deal_name_additional, null, ['class' => 'form-control', 'placeholder' => __('Add additional part')])); ?>
            ...
            <div class="col-6 form-group">
                <?php echo e(Form::label('stage_id', __('Deal Stage'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
        ...
        <div class="othersInfo" style="display: inline;">
            ...
            <fieldset>
                <legend><?php echo e(__('Basic Info')); ?></legend>
                ...
                <div class="row">
                    ...
                    <div class="my-2">
                        <img src="<?php echo e(asset('storage/app/public/' . $deal->company_entity_logo)); ?>" alt="<?php echo e(__('Company Logo')); ?>" class="img-thumbnail" style="width: 50px; height: 50px;">
                    </div>
                    <!-- Company/Entity Logo -->
                    <div class="col-6 form-group">
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('company_phone_ll2', null, array('class' => 'form-control', 'placeholder' => __('+966-11-1234567'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('address1', null, array('class' => 'form-control', 'placeholder' => __('Enter Address1'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('address2', null, array('class' => 'form-control', 'placeholder' => __('Enter Address2'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('region', null, array('class' => 'form-control', 'placeholder' => __('Enter Region/State'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('country', null, array('class' => 'form-control', 'placeholder' => __('Enter Country'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('zip_code', null, array('class' => 'form-control', 'placeholder' => __('Enter Zip Code'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::url('company_linkedin', null, array('class' => 'form-control', 'placeholder' => __('Enter LinkedIn URL'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('company_location', null, array('class' => 'form-control', 'placeholder' => __('Enter Location URL'),'required' => 'required'))); ?>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::select('salutation', ['Mr' => 'Mr', 'Mrs' => 'Mrs', 'Ms' => 'Ms'], null, array('class' => 'form-control select', 'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('first_name', null, array('class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter First Name'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('last_name', null, array('class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Last Name'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('mobile_primary', null, array('class' => 'form-control', 'placeholder' => __('+966(0)541145867'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('mobile_secondary', null, array('class' => 'form-control', 'placeholder' => __('+966(0)541145867'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::email('email_work', null, array('class' => 'form-control', 'placeholder' => __('name@domain.com'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::email('email_personal', null, array('class' => 'form-control', 'placeholder' => __('name@domain.com'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('phone_ll', null, array('class' => 'form-control', 'placeholder' => __('+966-11-1234567'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::text('company_phone_ll', null, array('class' => 'form-control', 'placeholder' => __('+966-11-1234567'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::number('extension', null, array('class' => 'form-control', 'placeholder' => __('Enter Extension Number'),'required' => 'required'))); ?>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <?php echo e(Form::url('linkedin_profile', null, array('class' => 'form-control', 'placeholder' => __('Enter LinkedIn URL'),'required' => 'required'))); ?>
...
<script>
    ...
    function getStages(id) {
        $.ajax({
            url: '<?php echo e(route('deals.json')); ?>',
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/deals/edit.blade.php ENDPATH**/ ?>