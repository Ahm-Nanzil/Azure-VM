                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Code')); ?></th> <!-- Added Code column -->
                                    <th><?php echo e(__('State')); ?></th> <!-- Added State column -->
                                    <th><?php echo e(__('Postal Code')); ?></th> <!-- Added Postal Code column -->
                                    <th><?php echo e(__('Display')); ?></th> <!-- Added Display column -->
                                    <th><?php echo e(__('Hide When Out of Stock')); ?></th> <!-- Added Hide When Out of Stock column -->
                                    <th><?php echo e(__('Note')); ?></th> <!-- Added Note column -->
                            ...
                            <tbody>
                                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="font-style">
                                        ...
                                        <td><?php echo e($warehouse->code); ?></td> <!-- Displaying the Code -->
                                        <td><?php echo e($warehouse->state); ?></td> <!-- Displaying the State -->
                                        <td><?php echo e($warehouse->postal_code); ?></td> <!-- Displaying the Postal Code -->
                                        <td><?php echo e($warehouse->display ? 'Yes' : 'No'); ?></td> <!-- Displaying Display status -->
                                        <td><?php echo e($warehouse->hide_when_out_of_stock ? 'Yes' : 'No'); ?></td> <!-- Displaying Hide When Out of Stock status -->
                                        <td><?php echo e($warehouse->note); ?></td> <!-- Displaying the Note -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/warehouse/index.blade.php ENDPATH**/ ?>