...
<?php $__env->startPush('script-page'); ?>
    ...
    var showLeadUrl = "<?php echo e(route('leads.show', $lead->id)); ?>";
    ...
    function reinitializeDropzone() {
        Dropzone.autoDiscover = false; // Disable Dropzone auto-discovery

        // Initialize Dropzone for the #dropzonewidget element
        myDropzone = new Dropzone("#dropzonewidget", {
            maxFiles: 20,
            parallelUploads: 1,
            filename: false,
        ...
        // Add event for sending CSRF token and lead ID
        myDropzone.on("sending", function (file, xhr, formData) {
            formData.append("_token", $('meta[name="csrf-token"]').attr('content'));
            formData.append("lead_id", <?php echo e($lead->id); ?>);
        });
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <div class="d-flex align-items-center mt-2">
        <a href="<?php echo e(route('leads.index')); ?>" class="text-black me-3">
            <i class="fas fa-arrow-left"></i> <!-- Font Awesome Left Arrow Icon -->
        </a>

        <?php if($lead->company_entity_logo): ?>
        <img src="<?php echo e(asset('storage/app/public/' . $lead->company_entity_logo)); ?>" alt="Company Logo" style="width: 32px; height: 32px; object-fit: cover; border-radius: 4px;">
        <?php else: ?>
            <i class="fas fa-building fa-2x me-2"></i>
        <?php endif; ?>

        <div>
            <h3 class="d-inline"><?php echo e($lead->company_entity_name); ?></h3>
            <p class="d-inline ms-2">
                <a href="<?php echo e($lead->company_website); ?>" target="_blank"><?php echo e($lead->company_website); ?></a>
            </p>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Dot')); ?>" class="btn btn-sm btn-primary">
            <i class="fas fa-ellipsis-h"></i> <!-- Font Awesome Three Dot Horizontal Icon -->
        </a>
            <?php if($previousLead): ?>
                <a href="<?php echo e(route('leads.show', $previousLead->id)); ?>" class="btn btn-sm btn-primary" title="<?php echo e(__('Previous Lead')); ?>">
                    <i class="fas fa-arrow-left"></i>
                </a>
            <?php endif; ?>

            <?php if($nextLead): ?>
                <a href="<?php echo e(route('leads.show', $nextLead->id)); ?>" class="btn btn-sm btn-primary" title="<?php echo e(__('Next Lead')); ?>">
                    ...
                    <div class="col-xl-9">
                                    ...
                                    <div class="col-md-4 col-sm-4 mt-4">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <h5 class="mb-0 text-primary"><?php echo e(!empty($lead->company_email)?$lead->company_email:''); ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 mt-4">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <h5 class="mb-0 text-warning"><?php echo e(!empty($lead->company_phone_ll1)?$lead->company_phone_ll1:''); ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 mt-4">
                        ...
                        <div class="card">
                            <div class="card-header" id="basicInfoHeader">
                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                    <?php echo e(__('Lead Basic Info')); ?>

                                    <div class="float-end">
                                    <a data-size="md" data-url="<?php echo e(route('leads.basicinfo.edit',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Basic Info')); ?>" data-title="<?php echo e(__('Edit Basic Info')); ?>" class="btn btn-sm btn-primary">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="float-end">
                                                    <a data-size="md" data-url="<?php echo e(route('leads.sources.edit',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Source')); ?>" data-title="<?php echo e(__('Add Source')); ?>" class="btn btn-sm btn-primary">
                                                                ...
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit lead')): ?>
                                                                    <td>
                                                                        <div class="action-btn bg-danger ms-2">
                                                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.sources.destroy', $lead->id,$source->id], 'class' => 'modalForm','id'=>'delete-form-'.$lead->id]); ?>
                        ...
                        <div id="primaryContactInfo" class="card mt-4">
                            <div class="card-header">
                                ...
                                <div class="float-end">
                                <a data-size="md" data-url="<?php echo e(route('leads.primarycontact.edit',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Primary Contact Info')); ?>" data-title="<?php echo e(__('Edit Primary Contact Info')); ?>" class="btn btn-sm btn-primary">
                                    <i class="fas fa-edit text-white"></i>
                                </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                ...
                                                <h5 class="mb-0"><?php echo e(!empty($lead->salutation) ? $lead->salutation : ''); ?></h5>
                                            </div>

                                            <!-- First Name -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('First Name')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->first_name) ? $lead->first_name : ''); ?></h5>
                                            </div>

                                            <!-- Last Name -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Last Name')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->last_name) ? $lead->last_name : ''); ?></h5>
                                            </div>

                                            <!-- Mobile Primary -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Mobile Primary')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->mobile_primary) ? $lead->mobile_primary : ''); ?></h5>
                                            </div>

                                            <!-- Mobile Secondary -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Mobile Secondary')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->mobile_secondary) ? $lead->mobile_secondary : ''); ?></h5>
                                            </div>

                                            <!-- Email Work -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Email Work')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->email_work) ? $lead->email_work : ''); ?></h5>
                                            </div>

                                            <!-- Email Personal -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Email Personal')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->email_personal) ? $lead->email_personal : ''); ?></h5>
                                            </div>

                                            <!-- Phone LL -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Phone LL')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->phone_ll) ? $lead->phone_ll : ''); ?></h5>
                                            </div>

                                            <!-- Company Phone LL -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Company Phone LL')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->company_phone_ll) ? $lead->company_phone_ll : ''); ?></h5>
                                            </div>

                                            <!-- Extension # -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Extension #')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->extension) ? $lead->extension : ''); ?></h5>
                                            </div>

                                            <!-- LinkedIn Profile -->
                                            <div class="col-md-6 col-sm-6 mt-3">
                                                <p class="text-muted text-sm mb-0"><?php echo e(__('LinkedIn Profile')); ?></p>
                                                <h5 class="mb-0"><?php echo e(!empty($lead->linkedin_profile) ? $lead->linkedin_profile : ''); ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h5><?php echo e(__('Additional Contacts')); ?></h5>
                                        ...
                                        <div class="float-end">
                                            <a data-size="md" data-bs-target="#contactModal" data-url="<?php echo e(route('leads.additional-contact.create',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create Additional Contact')); ?>" data-title="<?php echo e(__('Create Additional Contact')); ?>" class="btn btn-sm btn-primary">
                                                <i class="ti ti-plus text-white"></i>
                                            </a>
                            ...
                            <div id="additional-contact" class="collapse" aria-labelledby="">
                                ...
                                <div class="card-body">
                                    <div class="row" id="additional-contacts-list">
                                        <?php $__currentLoopData = json_decode($lead->additional_contacts, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="float-end">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit lead')): ?>
                                                            <div class="col-md-12 mt-2">
                                                                <div class="action-btn bg-danger ms-2">
                                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.additional_contacts.destroy', $lead->id, $index], 'class' => 'modalForm', 'id' => 'delete-form-' . $index]); ?>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="float-end">
                                                    <a  data-size="md" data-url="<?php echo e(route('leads.users.edit',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add User')); ?>" data-title="<?php echo e(__('Add User')); ?>" class="btn btn-sm btn-primary ">
                                                        <i class="ti ti-plus text-white"></i>
                                                    </a>
                                                        ...
                                                        <?php $__currentLoopData = $lead->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit lead')): ?>
                                                                    <td>
                                                                        <div class="action-btn bg-danger ms-2">
                                                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.users.destroy', $lead->id,$user->id],'class' => 'modalForm','id'=>'delete-form-'.$lead->id]); ?>
                                        ...
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create lead email')): ?>
                                                    <div class="float-end">
                                                        <a data-size="md" data-url="<?php echo e(route('leads.emails.create',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create Email')); ?>" data-title="<?php echo e(__('Create Email')); ?>" class="btn btn-sm btn-primary">
                                                            <i class="ti ti-plus text-white"></i>
                                                        </a>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="activityDropdown">
                                                <li>
                                                    ...
                                                    <a class="dropdown-item" data-size="md" data-url="<?php echo e(route('leads.calls.create', $lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Call')); ?>" data-title="<?php echo e(__('Add Call')); ?>">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" data-size="md" data-url="<?php echo e(route('leads.tasks.create', $lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Task')); ?>" data-title="<?php echo e(__('Add Task')); ?>">
                                                        <?php echo e(__('Add Task')); ?>

                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" data-size="md" data-url="<?php echo e(route('leads.meeting.create', $lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Meeting')); ?>" data-title="<?php echo e(__('Add Meeting')); ?>" >
                                                        <?php echo e(__('Add Meeting')); ?>

                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" data-size="md" data-url="<?php echo e(route('leads.visit.create', $lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Visit')); ?>" data-title="<?php echo e(__('Add Visit')); ?>" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete lead call')): ?>
                                                                    <div class="action-btn bg-danger ms-2">
                                                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.calls.destroy', $lead->id, $call->id], 'class' => 'modalForm', 'id' => 'delete-form-' . $lead->id]); ?>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                <div class="mb-3 mb-sm-0">
                                                                    <h5 class="mb-0">
                                                                        ...
                                                                        <?php if($task->status): ?>
                                                                            <div class="badge bg-primary mb-1"><?php echo e(__(\App\Models\LeadTasks::$status[$task->status])); ?></div>
                                                                        <?php else: ?>
                                                                            <div class="badge bg-warning mb-1"><?php echo e(__(\App\Models\LeadTasks::$status[$task->status])); ?></div>
                                                                        <?php endif; ?>
                                                                    </h5>
                                                                    <small class="text-sm"><?php echo e(__(\App\Models\LeadTasks::$priorities[$task->priority])); ?> - <?php echo e(Auth::user()->dateFormat($task->date)); ?> <?php echo e(Auth::user()->timeFormat($task->time)); ?></small>
                                                                    <span class="text-muted text-sm">
                                                                        <?php if($task->status): ?>
                                                                            <div class="badge badge-pill badge-success mb-1"><?php echo e(__(\App\Models\LeadTasks::$status[$task->status])); ?></div>
                                                                        <?php else: ?>
                                                                            <div class="badge badge-pill badge-warning mb-1"><?php echo e(__(\App\Models\LeadTasks::$status[$task->status])); ?></div>
                                                                        <?php endif; ?>
                                                                    </span>
                                                                </div>
                                                                <span>
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit task')): ?>
                                                                        <div class="action-btn bg-info ms-2">
                                                                        <a href="#" class=""  data-url="<?php echo e(route('leads.tasks.edit',[$lead->id,$task->id])); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Task')); ?>"><i class="ti ti-pencil text-white"></i></a>
                                                                    </div>
                                                                    <?php endif; ?>
                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete task')): ?>
                                                                        <div class="action-btn bg-danger ms-2">
                                                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.tasks.destroy',$lead->id,$task->id], 'class' => 'modalForm']); ?>
                                                                            ...
                                                                            <td>
                                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit meeting')): ?>
                                                                                    <div class="action-btn bg-primary ms-2">
                                                                                        <a href="#" data-url="<?php echo e(route('leads.meeting.edit',[$lead->id,$meeting->id])); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Meeting')); ?>" data-title="<?php echo e(__('Edit Meeting')); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>"><i class="ti ti-pencil text-white"></i></a>
                                                                                    </div>
                                                                                <?php endif; ?>
                                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete meeting')): ?>
                                                                                <div class="action-btn bg-danger ms-2">
                                                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.meeting.destroy',$lead->id,$meeting->id], 'class' => 'modalForm']); ?>
                                            ...
                                            <?php $__currentLoopData = $views; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="lead-view-item" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px; border: 1px solid #ddd; padding: 15px;">
                                                    ...
                                                    <span>
                                                                ...
                                                                <div class="action-btn bg-info ms-2">
                                                                <a href="#" class="" data-title="<?php echo e(__('Edit Visit')); ?>" data-url="<?php echo e(route('leads.visit.edit',[$lead->id,$view->id])); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"><i class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                            
                                                            
                                                                <div class="action-btn bg-danger ms-2">
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.visit.destroy',$lead->id,$view->id], 'class' => 'modalForm']); ?>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="float-end">
                                                    <a data-size="md" data-url="<?php echo e(route('leads.products.edit',$lead->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add Product')); ?>" data-title="<?php echo e(__('Add Product')); ?>" class="btn btn-sm btn-primary">
                                                        <i class="ti ti-plus text-white"></i>
                                                    </a>
                                                        ...
                                                        <?php $__currentLoopData = $lead->products(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit lead')): ?>
                                                                    <td>
                                                                        <div class="action-btn bg-danger ms-2">
                                                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['leads.products.destroy', $lead->id,$product->id], 'class' => 'modalForm']); ?>
                                ...
                                <div class="col-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php echo e(Form::model($lead, array('route' => array('leads.discussion.store', $lead->id), 'method' => 'POST', 'class' => 'modalForm'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/leads/show.blade.php ENDPATH**/ ?>