...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('expiry_time', __('Expiry Time'), ['class' => 'form-label'])); ?>

                <?php echo e(Form::date('expiry_time', null, ['class' => 'form-control', 'min' => \Carbon\Carbon::now()->format('Y-m-d'), 'placeholder' => __('Select Expiry Date')])); ?>
...
<?php /**PATH C:\xampp\htdocs\Portfolio\myportfolio\ErpProject\resources\views/user/create.blade.php ENDPATH**/ ?>