<?php if(isset($call)): ?>
    <?php echo e(Form::model($call, array('route' => array('leads.calls.update', $lead->id, $call->id), 'method' => 'PUT', 'class' => 'modalForm'))); ?>

<?php else: ?>
    
    <?php echo e(Form::open(array('route' => array('leads.calls.store', $lead->id), 'class' => 'modalForm'))); ?>
...
<?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/leads/calls.blade.php ENDPATH**/ ?>