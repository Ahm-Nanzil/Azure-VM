...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Reciept Return Edit')); ?></li>
    <?php else: ?>
    <li class="breadcrumb-item"><?php echo e(__('Reciept Return Create')); ?></li>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    <?php if(isset($orderReturn)): ?>
                        <?php echo e(Form::model($orderReturn, array('route' => array('inventory.cust-supp.update', $orderReturn->id), 'method' => 'post','enctype' => 'multipart/form-data','class' => 'modalForm'))); ?>

                    <?php else: ?>
                        <?php echo e(Form::open(array('route' => ['inventory.cust-supp.store'], 'enctype' => 'multipart/form-data','class' => 'modalForm'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Soudi\ERPNBS\erpnbs\resources\views/cust_supp/create.blade.php ENDPATH**/ ?>