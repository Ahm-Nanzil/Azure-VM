@if(isset($call))
    {{ Form::model($call, array('route' => array('leads.calls.update', $lead->id, $call->id), 'method' => 'PUT', 'class' => 'modalForm')) }}
@else
    {{-- {{ Form::open(array('route' => ['leads.calls.store',$lead->id]), 'class' => 'modalForm') }} --}}
    {{ Form::open(array('route' => array('leads.calls.store', $lead->id), 'class' => 'modalForm')) }}
