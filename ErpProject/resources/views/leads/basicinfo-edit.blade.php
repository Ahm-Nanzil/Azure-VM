{{ Form::model($lead, array('route' => array('leads.basicinfo.update', $lead->id), 'method' => 'PUT','class' => 'modalForm')) }}
        ...
        <div class="row">
            ...
            <div class="col-6 form-group">
                ...
                @if($lead->company_entity_logo )
                    <div class="my-2">
                        <img src="{{ asset('storage/app/public/' . $lead->company_entity_logo) }}" alt="{{ __('Company Logo') }}" class="img-thumbnail" style="width: 32px; height: 32px;">
                    </div>
                @endif
