@if(isset($task))
    {{ Form::model($task, array('route' => array('leads.tasks.update', $lead->id, $task->id), 'method' => 'PUT','class' => 'modalForm')) }}
@else
    {{ Form::open(array('route' => ['leads.tasks.store',$lead->id], 'class' => 'modalForm')) }}
@endif
