                                ...
                                <div class="card-body">
                                    <div class="row text-xs">
                                        ...
                                        @elseif($emailTemplate->slug=='warning_sent')
                                            ...
                                            <div class="row">
                                                <p class="col-4">{{__('Task Creator')}} : <span class="pull-end text-primary">{task_creator}</span></p>
                                                ...
                                                <p class="col-4">{{__('From')}} : <span class="pull-right text-primary">{from}</span></p>
                                                <p class="col-4">{{__('From Name')}} : <span class="pull-right text-primary">{from_name}</span></p>
                                                <p class="col-4">{{__('Pipeline')}} : <span class="pull-right text-primary">{pipeline}</span></p>
                                                <p class="col-4">{{__('Stage')}} : <span class="pull-right text-primary">{stage}</span></p>
                                                <p class="col-4">{{__('Task Link')}} : <span class="pull-right text-primary"><a href="{task_link}">{task_link}</a></span></p>
                                                <p class="col-4">{{__('Company Name')}} : <span class="pull-right text-primary">{company_name}</span></p>
                                            </div>
                                            @elseif($emailTemplate->slug == 'new_visit')
                                                <div class="row">
                                                    <p class="col-4">{{__('Visit Creator')}} : <span class="pull-right text-primary">{visit_creator}</span></p>
                                                    <p class="col-4">{{__('Visit Name')}} : <span class="pull-right text-primary">{visit_name}</span></p>
                                                    <p class="col-4">{{__('From')}} : <span class="pull-right text-primary">{from}</span></p>
                                                    <p class="col-4">{{__('From Name')}} : <span class="pull-right text-primary">{from_name}</span></p>
                                                    <p class="col-4">{{__('Pipeline')}} : <span class="pull-right text-primary">{pipeline}</span></p>
                                                    <p class="col-4">{{__('Stage')}} : <span class="pull-right text-primary">{stage}</span></p>
