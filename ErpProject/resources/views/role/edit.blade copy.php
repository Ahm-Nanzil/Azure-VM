                            ...
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="">
                                    ...
                                    <tr class="expandable-row">
                                        ...
                                        <td>
                                            <label class="ischeck crm_checkall toggle-row" data-id="{{str_replace(' ', '', $module)}}">{{ ucfirst($module) }}</label>
                                        </td>
                                        <td>
                                            <div class="row">
                                                @if(in_array('manage '.$module,(array) $permissions))
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            // Toggle visibility of the details rows when the corresponding toggle-row label is clicked
                                            $('.toggle-row').on('click', function() {
                                                // Find the closest 'tr' (expandable-row) and toggle all subsequent details rows until the next expandable-row
                                                $(this).closest('tr').nextUntil('.expandable-row', '.details-row').toggle();
                                            });
                                        });
                                    </script>
