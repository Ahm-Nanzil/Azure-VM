    ...
    <div class="card sticky-top" style="top:30px">
        ...
        <div class="list-group list-group-flush" id="useradd-sidenav">
            ...
            <ul id="general-settings" class="collapse">
                <li><a href="#brand-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Brand Settings">{{ __('Brand Settings') }}</a></li>
                <li><a href="#system-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="System Settings">{{ __('System Settings') }}</a></li>
                <li><a href="#company-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Company Settings">{{ __('Company Settings') }}</a></li>
                <li><a href="#currency-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Currency Settings">{{ __('Currency Settings') }}</a></li>
            </ul>
            ...
            <ul id="security-settings" class="collapse">
                <li>
                    <a href="#ip-restriction-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="IP Restriction Settings">{{ __('IP Restriction Settings') }}</a>

                </li>
                <li>
                    <a href="#recaptcha-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="ReCaptcha Settings">{{ __('ReCaptcha Settings') }}</a>
            ...
            <ul id="customization-settings" class="collapse">
                <li>
                    <a href="#seo-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="SEO Settings">{{ __('SEO Settings') }}</a>

                </li>
                <li>
                    <a href="#email-notification-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Email Notification Settings">{{ __('Email Notification Settings') }}</a>

                </li>
                <li>
                    <a href="#offer-letter-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Offer Letter Settings">{{ __('Offer Letter Settings') }}</a>

                </li>
                <li>
                    <a href="#joining-letter-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Joining Letter Settings">{{ __('Joining Letter Settings') }}</a>

                </li>
                <li>
                    <a href="#experience-certificate-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Experience Certificate Settings">{{ __('Experience Certificate Settings') }}</a>

                </li>
                <li>
                    <a href="#noc-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="NOC Settings">{{ __('NOC Settings') }}</a>
            ...
            <ul id="communication-settings" class="collapse">
                <li>
                    <a href="#email-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Email Settings">{{ __('Email Settings') }}</a>

                </li>
                <li>
                    <a href="#pusher-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Pusher Settings">{{ __('Pusher Settings') }}</a>

                </li>
                <li>
                    <a href="#zoom-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Zoom Settings">{{ __('Zoom Settings') }}</a>

                </li>
                <li>
                    <a href="#slack-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Slack Settings">{{ __('Slack Settings') }}</a>

                </li>
                <li>
                    <a href="#telegram-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Telegram Settings">{{ __('Telegram Settings') }}</a>

                </li>
                <li>
                    <a href="#twilio-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Twilio Settings">{{ __('Twilio Settings') }}</a>
            ...
            <ul id="integration-settings" class="collapse">
                <li>
                    <a href="#google-calendar-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Google Calendar Settings">{{ __('Google Calendar Settings') }}</a>

                </li>
                <li>
                    <a href="#webhook-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Webhook Settings">{{ __('Webhook Settings') }}</a>

                </li>
                <li>
                    <a href="#chat-gpt-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Chat GPT Settings">{{ __('Chat GPT Settings') }}</a>
            ...
            <ul id="storage-cache-settings" class="collapse">
                <li>
                    <a href="#storage-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Storage Settings">{{ __('Storage Settings') }}</a>

                </li>
                <li>
                    <a href="#cache-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Cache Settings">{{ __('Cache Settings') }}</a>
            ...
            <ul id="attendance-settings" class="collapse">
                <li>
                    <a href="#tracker-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Time Tracker Settings">{{ __('Time Tracker Settings') }}</a>

                </li>
                <li>
                    <a href="#biometric-attendance" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Biometric Attendance Settings">{{ __('Biometric Attendance Settings') }}</a>
