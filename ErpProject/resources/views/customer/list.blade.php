...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('customer.index') }}" data-bs-toggle="tooltip" title="{{__('Kanban View')}}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($customers as $k=>$customer)
                                <tr class="cust_tr" id="cust_detail" data-url="{{route('customer.show',$customer['id'])}}" data-id="{{$customer['id']}}">
                                    ...
                                    <td>{{ $customer->pipeline->name ?? '' }}</td>
                                    <td>{{ $customer->stage->name ?? '' }}</td>
