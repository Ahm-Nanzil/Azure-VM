{{ Form::model($customer, array('route' => array('customer.basicinfo.update', $customer->id), 'method' => 'PUT','class' => 'modalForm')) }}
        ...
        <div class="row">
            ...
            <div class="col-12 form-group">
                ...
                @if($customer->company_entity_logo )
                    <div class="my-2">
                        <img src="{{ asset('storage/app/public/' . $customer->company_entity_logo) }}" alt="{{ __('Company Logo') }}" class="img-thumbnail" style="width: 32px; height: 32px;">
                    </div>
                @endif
